...
function PAF.Dialog_SetUpUsePAFCheckbox()
    ...
    button:SetPoint("LEFT", LFGListFrame.ApplicationViewer.RefreshButton, "LEFT", -53, 0)
...
PVEFrame:HookScript("OnShow", PAF.Dialog_Toggle)
PVEFrame:HookScript("OnHide", PAF.Dialog_Toggle)
