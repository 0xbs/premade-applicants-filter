...
function PAF.Dialog_InfoButton_OnEnter(self, motion)
    ...
    PAF.GameTooltip_AddWhite("all(\"friend or (ilvl > 400 and heal)\")")
    PAF.GameTooltip_AddWhite("some(\"tank\") and all(\"mprating > 1000\")")
    GameTooltip:AddLine(" ")
    GameTooltip:AddDoubleLine(L["dialog.tooltip.quantifier"], L["dialog.tooltip.description"])
    PAF.GameTooltip_AddDoubleWhite("all/every", L["dialog.tooltip.all"])
    PAF.GameTooltip_AddDoubleWhite("some/exists", L["dialog.tooltip.some"])
    PAF.GameTooltip_AddDoubleWhite("none", L["dialog.tooltip.none"])
    GameTooltip:AddLine(" ")
    GameTooltip:AddDoubleLine(L["dialog.tooltip.variable"], L["dialog.tooltip.description"])
    AddDoubleWhiteUsingKey("members")
    GameTooltip:AddLine(" ")
    GameTooltip:AddDoubleLine(L["dialog.tooltip.variable.quantified"], L["dialog.tooltip.description"])
    AddDoubleWhiteUsingKey("level")
    AddDoubleWhiteUsingKey("ilvl")
    AddDoubleWhiteUsingKey("pvplvl")
    ...
    AddDoubleWhiteUsingKey("mpmaprating")
    AddDoubleWhiteUsingKey("mpmapmaxkey")
    AddDoubleWhiteUsingKey("mpmapintime")
    GameTooltip:AddLine(" ")
